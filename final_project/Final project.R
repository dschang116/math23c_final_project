...
#------------------------------------------------------------------------------
# Required dataset standards. Additional points in parenthesis.
#------------------------------------------------------------------------------

# 1. dataframe
# 2. has at least two categorical or logical columns
# 3. has at least two numeric columns
# 4. has close to 1000 rows

# (1) large data set with pts of columns, allows for comparison of many different variables
# (2) data set is so large that it can be used as a population from which samples are taken
...
#------------------------------------------------------------------------------
# Required graphical displays. Additional points in parenthesis.
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# Required analysis. Additional points in parenthesis.
#------------------------------------------------------------------------------

# 1. Permutation test

# (9) A convincing demonstration of a relationship that might have been statistically significant
...
# (5) graphical display that is different from those in the textbook or in the class scripts
